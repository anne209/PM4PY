...
def filter_log(start_acts, end_acts, log, min_ratio=0.1, end_crit=None, delete_activities=None):
...
filtered_log= filter_log(start_activities, end_activities, log_sepsis, end_crit=criteria_end, delete_activities=deleted_activities)
print(filtered_log)
